...
local garages = {
	...
	[8] = { locked = false, camera = {x = -1755.092, y = 3049.597, z = 34.454, heading = 143.840}, driveout = {x = -1755.461,y = 3056.094, z = 32.825, heading = 326.187}, drivein = {x = -1759.247,y = 3058.229, z = 32.823, heading = 187.599}, outside = {x = -1752.709,y = 3058.762, z = 32.829, heading = 298.531}, inside = {x = -1758.556,y = 3050.991, z = 32.818, heading = 185.213} }
}
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		LSCMenu.categories.buttons = {}
			...
			--Calculate price for vehicle repair and add repair  button. Hvis der ikke er en mekaniker på arbejde.
			local maxvehhp = 1000
			local damage = 0
			damage = (maxvehhp - GetVehicleBodyHealth(veh))/10
			LSCMenu:addPurchase("Reparer køretøj",round(250+150+1200*damage,0), "Fuld køretøjs reparation og motor tjek.")
	...
	--	AddMod(18, LSCMenu.categories, "TURBO", "Turbo", "Tu tu tuuuuuu.",false)
...
if (biler[myveh.model]) then
	myveh.model = biler[myveh.model]
end
